...
WebUI.check(findTestObject('Competitor Behaviour/select_Vehicle - ThriftyNZ - Corolla'))
WebUI.click(findTestObject('Competitor Behaviour/select_Vehicle'))
...
// Select Rate Type
WebUI.click(findTestObject('Competitor Behaviour/Rate Type'))
WebUI.selectOptionByLabel(findTestObject('Competitor Behaviour/Rate Type'),'Gross',false)
WebUI.click(findTestObject('Competitor Behaviour/Rate Type'))
...
// Select Rate Type
WebUI.click(findTestObject('Competitor Behaviour/Rate Type'))
WebUI.selectOptionByLabel(findTestObject('Competitor Behaviour/Rate Type'),'Net',false)
WebUI.click(findTestObject('Competitor Behaviour/Rate Type'))
