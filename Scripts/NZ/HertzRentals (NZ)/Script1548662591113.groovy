...
WebUI.check(findTestObject('Competitor Behaviour/select_Vehicle - HertzNZ - Aurion'))
WebUI.click(findTestObject('Competitor Behaviour/select_Vehicle'))
...
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Avis (HertzNZ)')) // Select Avis
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Budget (HertzNZ)')) // Select Budget
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Thrifty - NZ')) // Select Thrifty
