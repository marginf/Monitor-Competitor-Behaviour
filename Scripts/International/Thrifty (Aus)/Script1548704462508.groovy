...
WebUI.selectOptionByValue(findTestObject('Competitor Behaviour/Market'),Australia, false)
WebUI.click(findTestObject('Competitor Behaviour/Market'))
...
WebUI.selectOptionByLabel(findTestObject('Competitor Behaviour/select_Pickup'), 'Melbourne Airport', false)
...
WebUI.selectOptionByLabel(findTestObject('Competitor Behaviour/Dropoff Location'),'Melbourne Airport', false)
//WebUI.selectOptionByValue(findTestObject('Competitor Behaviour/Dropoff Location'),'041c2f3a-4912-437f-a404-6c17064efe22',false)
WebUI.click(findTestObject('Competitor Behaviour/Dropoff Location'))
...
//WebUI.selectOptionByValue(findTestObject('Competitor Behaviour/Vategory Type'),'0fe6fdbe-50ed-4b99-91e5-2abf9413f8f8',false)
WebUI.click(findTestObject('Competitor Behaviour/Category Type'))
...
WebUI.check(findTestObject('Competitor Behaviour/select_Vehicle - ThriftyAU - Ford EcoSport'))
WebUI.check(findTestObject('Competitor Behaviour/select_Vehicle - ThriftyAU - Corolla'))
WebUI.click(findTestObject('Competitor Behaviour/select_Vehicle'))

// Select Competitor Channel
WebUI.click(findTestObject('Competitor Behaviour/Competitor Channel'))
WebUI.selectOptionByLabel(findTestObject('Competitor Behaviour/Competitor Channel'),'Drivenow',false)
WebUI.click(findTestObject('Competitor Behaviour/Competitor Channel'))
...
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Alamo Australia (Thrifty)')) 
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Avis (Thrifty)')) 
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Budget (Thrifty)')) 
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Enterprise Australia (Thrifty)')) 
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Firefly (Thrifty)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Hertz (Thrifty)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Jucy (Thrifty)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - RedSpot Rental (Thrifty)'))
WebUI.click(findTestObject('Competitor Behaviour/Competitor - DropDown'))
