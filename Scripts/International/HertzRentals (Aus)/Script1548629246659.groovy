...
WebUI.check(findTestObject('Competitor Behaviour/select_Vehicle - HertzAU - Corolla'))
WebUI.click(findTestObject('Competitor Behaviour/select_Vehicle'))
...
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Avis (Hertz)')) // Select Avis
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Budget (Hertz)')) // Select Budget
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Thrifty')) // Select Thrifty
