...
WebUI.check(findTestObject('Competitor Behaviour/select_Vehicle - AceAU - Corolla'))
WebUI.click(findTestObject('Competitor Behaviour/select_Vehicle'))
...
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Apex (Ace)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Avis (Hertz)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Bargain (Ace)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Budget (Hertz)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Firefly (Ace)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Hertz (Ace)'))
WebUI.check(findTestObject('Competitor Behaviour/Competitor - Thrifty'))
WebUI.click(findTestObject('Competitor Behaviour/Competitor - DropDown'))
